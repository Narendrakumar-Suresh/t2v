"""
train_c.py — Model C: Mamba2 + Mamba2 — FIXED
================================================
501M | dim=576 | 26 layers | state_dim=128 | expand=4
~4.1hrs MI300X | ~$8
"""
...
def train():
    ...
    loader = DataLoader(
        VideoLatentDataset(use_merged=cfg.use_merged, max_text_len=cfg.max_text_len),
